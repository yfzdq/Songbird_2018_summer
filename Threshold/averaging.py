...
'''
def plot_results(compression, threshold, duration, t_line, file_name):
    ...
    plt.stem(x_label, compression, markerfmt=' ')
    plt.stem(x_label, negative_compression, markerfmt = ' ')
    # threshold line
    plt.hlines(y=t_line, xmin=0, xmax=duration, linewidth=2, color='r')
